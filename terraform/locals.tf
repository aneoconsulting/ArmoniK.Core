locals {
  ...
  queue              = one(concat(module.queue_activemq, module.queue_rabbitmq, module.queue_artemis, module.queue_pubsub, module.queue_sqs, module.queue_nats, module.queue_broker, module.queue_none))
  database           = one(concat(module.database_mongo, module.database_postgresql))
  object             = one(concat(module.object_redis, module.object_minio, module.object_gcs, module.object_local, module.object_embed, module.object_null))
