...
FROM mcr.microsoft.com/dotnet/aspnet:11.0-azurelinux3.0-distroless AS base-linux
...
FROM --platform=$BUILDPLATFORM mcr.microsoft.com/dotnet/sdk:11.0 AS build-linux
