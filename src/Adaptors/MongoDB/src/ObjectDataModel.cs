  ...
  public class ObjectDataModel : IMongoDataModel<ObjectDataModel>
  {
      ...
      IMongoCollection<ObjectDataModel> collection)
    {
      ...
      var indexModels = new CreateIndexModel<ObjectDataModel>[]
                        {
                          new(iDIndex,
                              new CreateIndexOptions { Name = nameof(iDIndex), Unique = true }),
                          new(keyIndex,
                              new CreateIndexOptions { Name = nameof(keyIndex) }),
                          new(combinedIndex,
                              new CreateIndexOptions { Name = nameof(combinedIndex), Unique = true }),
                        };
