...
|----------------------------------|-------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------|
| Pollster__CacheEvictionThreshold | 0     | Agent level cache for tasks input and output data. These data can be reused locally directly. Cache folder can be shared between agents on the same node. Disabled when set to 0. | Preview |
|                                  |       |                                                                                                                                                                            |
