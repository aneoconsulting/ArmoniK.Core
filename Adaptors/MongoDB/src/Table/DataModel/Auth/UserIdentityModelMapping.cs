...
public class UserIdentityModelMapping : IMongoDataModelMapping<UserIdentityResult>
{
  static UserIdentityModelMapping()
  {
      ...
      BsonClassMap.RegisterClassMap<UserIdentityResult>(cm =>
                                                        {
                                                          ...
                                                          cm.MapProperty(nameof(UserIdentityResult.Username))
                                                            .SetIsRequired(true);
                                                          cm.MapProperty(nameof(UserIdentityResult.Roles))
                                                            .SetIsRequired(true);
