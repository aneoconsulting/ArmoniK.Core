...
/// <summary>
///   Represents the configuration settings for PostgreSQL table storage.
/// </summary>
[PublicAPI]
public class TableStorage
{
  /// <summary>
  ///   The configuration section path used to retrieve settings related to PostgreSQL table storage.
  /// </summary>
  public const string SettingSection = nameof(PostgreSQL) + ":" + nameof(TableStorage);
