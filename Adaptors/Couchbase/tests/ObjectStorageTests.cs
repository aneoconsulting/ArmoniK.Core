...
public class ObjectStorageTests : ObjectStorageTestBase
{
  ...
  public static async Task OneTimeSetUp()
  {
    try
    {
      ...
      _sharedCouchbaseContainer = new CouchbaseBuilder()
  ...
  protected override void GetObjectStorageInstance()
  {
    try
    {
      ...
      Dictionary<string, string?> minimalConfig = new()
                                                  {
                                                    { "Couchbase:BucketName", _sharedBucketName },
                                                    { "Couchbase:ScopeName", "_default" },
                                                    { "Couchbase:CollectionName", "_default" },
                                                  };
      ...
      services.AddOption(configuration,
                         ...
                         out Options.Couchbase couchbaseOptions);
