...
namespace ArmoniK.Core.Adapters.Gcs.Tests;
...
public class ObjectStorageTests : ObjectStorageTestBase
{
  ...
  private static readonly string GcsPath =
    $"{Path.DirectorySeparatorChar}src{Path.DirectorySeparatorChar}bin{Path.DirectorySeparatorChar}Debug{Path.DirectorySeparatorChar}net10.0{Path.DirectorySeparatorChar}ArmoniK.Core.Adapters.Gcs.dll";
  ...
  protected override void GetObjectStorageInstance()
  {
    Dictionary<string, string?> minimalConfig = new()
                                                {
                                                  {
                                                    "Components:ObjectStorageAdaptorSettings:ClassName", "ArmoniK.Core.Adapters.Gcs.ObjectBuilder"
                                                  },
                                                  {
                                                    "Components:ObjectStorageAdaptorSettings:AdapterAbsolutePath", $"{SolutionRoot}{GcsPath}"
                                                  },
                                                  {
                                                    "Gcs:ProjectId", "test-project"
                                                  },
                                                  {
                                                    "Gcs:BucketName", "armonik-test-bucket"
                                                  },
                                                  {
                                                    "Gcs:EmulatorEndpoint", "http://127.0.0.1:4443/storage/v1/"
                                                  },
                                                };
